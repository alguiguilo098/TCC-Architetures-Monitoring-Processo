...
% TCC2:
 ...
 \goal{Trabalho de Conclusão de Curso de Graduação apresentado (a)}
 \course{Trabalho de Conclusão de Curso 2}


% Dados do TCC (precisa alterar)
\author{Guilherme Almeida Lopes}  % Seu nome
\authorbib{Lopes, Guilherme} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{Desenvolvimento de um agente leve para monitoramento de processos em Linux em uma arquitetura Big Data voltada à cibersegurança} % Título do trabalho
...
\titleFA{Desenvolvimento de um agente leve para monitoramento de processos em Linux em uma arquitetura Big Data voltada à cibersegurança}

\titleen{DEVELOPMENT OF A LIGHTWEIGHT AGENT FOR MONITORING PROCESSES IN LINUX IN A BIG DATA ARCHITECTURE FOCUSED ON CYBERSECURITY} % Título traduzido para inglês
\advisor{Rodrigo Campiolo} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
...
\evalboardmember{Rodrigo Campiolo
}{Doutorado}{Universidade Tecnológica Federal do Paraná - UTFPR}
\evalboardmember{Luiz Arthur Feitosa dos Santos}{Doutorado}{Universidade Tecnológica Federal do Paraná - UTFPR}
\evalboardmember{Nome completo e por extenso do Membro 3 (de acordo com o Currículo Lattes)
}{Título (Titulação (Especialização, Mestrado, Doutorado)}{Universidade Tecnológica Federal do Paraná - UTFPR}
...
\PalavraChaveA{Sistema Operacional}%% Palavra-chave A
\PalavraChaveB{Linux}%% Palavra-chave B
\PalavraChaveC{Detec\c{c}\~ao de anomalias}%% Palavra-chave C
\PalavraChaveD{Visualiza\c{c}\~ao em tempo real}%% Palavra-chave D
...
\KeywordA{Process monitoring}%% Keyword A
\KeywordB{Big Data}%% Keyword B
